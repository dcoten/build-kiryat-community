  ...
  return (
    <div className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          src="/galilview.jpeg"
          alt="נוף גלילי קריית שמונה - הגרעין המשימתי של קריית שמונה במקום מדהים בצפון ישראל"
      ...
      <div ref={heroRef} className="container mx-auto px-4 z-10 text-center">
        <div className="animate-fade-in max-w-4xl mx-auto">
          ...
          <div className="text-xl md:text-2xl font-light text-white mb-8 max-w-3xl mx-auto space-y-4 text-balance" style={{ textShadow: '0 1px 3px rgba(0,0,0,0.6)' }}>
            ...
            <p>
              אנחנו בתחילת הדרך لבנות קהילה חדשה ומגוונת בקריית שמונה – עם משפחות מכל הארץ.
            </p>
            <p>
